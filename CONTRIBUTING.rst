...
1. Fork `the repository <https://github.com/gonzalocasas/git_demo>`_ and clone the fork.
...
When `reporting a bug <https://github.com/gonzalocasas/git_demo/issues>`_
please include:
...
`Github <https://github.com/gonzalocasas/git_demo/issues>`_. If you are proposing a feature:
